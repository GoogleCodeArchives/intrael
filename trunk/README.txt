...
* t * = Select the object with the smallest width/height ratio.

* T * = Select the object with the greatest width/height ratio.

* q * = Select the object with the lowest density (pixel count / (width in px*height in px)).

* Q * = Select the object with the greatest density (pixel count / (width in px*height in px)).

* w * = Select the object with the lowest (width in pixels*Average depth).

* W * = Select the object with the greatest (width in pixels*Average depth).

* h * = Select the object with the lowest (height in pixels*Average depth).

* H * = Select the object with the greatest (height in pixels*Average depth).
